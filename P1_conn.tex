...
\end{proposition}
\marginpar{For spaces or spectra???}
\begin{proof}
...
\begin{remark}
  ...
  localization. In particular, the sheaves
  $\pi_n^{\bbA^1}\Sigma^{\infty}_s\calX$ are isomorphic to
...
may therefore apply the general machinery of \cite{H-Spt} to
